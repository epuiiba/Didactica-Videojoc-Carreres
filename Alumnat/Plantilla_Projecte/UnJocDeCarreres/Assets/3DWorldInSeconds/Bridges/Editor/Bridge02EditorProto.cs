...
namespace WorldInSeconds3DProto
{
    ...
    [CustomEditor(typeof(Bridge02Proto))]
    public class Bridge02EditorProto : Editor
    {
        private Bridge02Proto _myTarget;
        ...
        void OnEnable()
        {
            _myTarget = (Bridge02Proto)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("TITLE: ", "Stone Bridge", TitleStyle);
            GUILayout.Space(10);
            ...
            if (GUILayout.Button("<b>Help</b>\n<size=10>To know what each field means</size>", richButtonStyle))
            {
                ...
                string helpFileUrl = documentationPath + "/Stone Bridge Contents.html"; 
            ...
            if (_myTarget.IsPrototype())
            {
                ...
                {
                    EditorGUILayout.HelpBox("With the 'Tutorial' option checked, you get a fully textured bridge between specific B1 and B2 points in the Tutorial scene.", MessageType.Warning);
                }
            }
